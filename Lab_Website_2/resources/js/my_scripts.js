...
function loadStatsPage(){
	...
	var win_loss = document.getElementById("win_loss_table");
	win_loss.rows[1].cells[0].innerHTML = wins;
	win_loss.rows[1].cells[1].innerHTML = loss;
}
...
function loadPlayersPage(){
	...
	for(var i =0; i < players.length; i++){
		selectText +=  '<a href="#" onclick="switchPlayers(' + i + ')"> '+ players[i].name + ' </a><br>';
		console.log(players[i]);
	}
	document.getElementById("player_selector").innerHTML = selectText;
}

function switchPlayers(playerNum){
	//alt:"Image of Player 1", year:"Sophomore", major:"Art", games_played: 23, pass_yards: 435, rushing_yards: 200, receiving_yards: 88
